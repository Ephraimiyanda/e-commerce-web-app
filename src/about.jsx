...
<div className="first-half">
    ...
    <img className="fruit" src={about} alt=""></img>
...
<div className="team "> <img className="people" src={rectangle} alt=""></img><span>Salamatu ceesay</span><p>Designer</p></div>
    ...
    <div className="team "> <img className="people" src={rectangle}  alt=""></img><span>Antonia  </span><p>Frontend Designer</p></div>
    <div className="team "><img className="people" src= {rectangle} alt=""></img><span>Fauziyya Tajudeen </span><p>Backend Designer</p></div>
    <div className="team "> <img className="people" src={rectangle}  alt=""></img><span>Chiamaka </span><p>Frontend Designer</p></div>
    <div className="team "><img className="people" src={rectangle} alt=""></img><span>Ephraim</span><p>Frontend Designer</p></div>
